 ...
 */
final class Version20200705074450 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, user_agent VARCHAR(255) NOT NULL, ip VARCHAR(255) NOT NULL, time DATETIME NOT NULL, event_type VARCHAR(255) NOT NULL, action_result VARCHAR(255) NOT NULL)');
